    ...
    <div ref={containerRef} className="min-h-screen bg-[var(--color-cream,#FDF8F3)]">
      ...
      <section className="relative overflow-hidden py-24 md:py-32">
        ...
        <div className="relative max-w-5xl mx-auto px-6 text-center">
          ...
          <h1 className="about-hero-title text-4xl md:text-6xl font-serif font-bold text-[var(--color-chocolate,#2C1810)] mb-6 leading-tight">
            About Trinetra Eye Care
          </h1>
          <p className="about-hero-subtitle text-lg md:text-xl text-[#5C4033] max-w-2xl mx-auto leading-relaxed">
            A center of excellence in ophthalmic care, where world-class
            expertise meets heartfelt compassion in the heart of Nepal.
          </p>
        </div>
      </section>
      ...
      <section ref={storyRef} className="py-20 md:py-28">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-6">
            <h2 className="story-line text-3xl md:text-4xl font-serif font-bold text-[var(--color-chocolate,#2C1810)] leading-snug">
              A Vision Born from Global Experience
            </h2>
            <p className="story-line text-lg text-[#5C4033] leading-relaxed">
              Trinetra Eye Care Center was founded by{" "}
              <span className="font-semibold text-[var(--color-chocolate,#2C1810)]">
                Dr. Bijay Regmi
              </span>
              , a distinguished ophthalmologist who spent over{" "}
              <span className="font-semibold text-[var(--color-chocolate,#2C1810)]">
                15 years
              </span>{" "}
              honing his craft across Germany and the Middle East.
            </p>
            <p className="story-line text-lg text-[#5C4033] leading-relaxed">
              During his years abroad, Dr. Regmi trained at some of the world&rsquo;s
              most prestigious ophthalmic institutions, mastering advanced surgical
              techniques and adopting patient care philosophies that prioritize both
      ...
      {/* Mission & Vision */}
      <section className="mission-section py-20 md:py-28 bg-gradient-to-b from-[#F5EDE4]/50 to-[#FDF8F3]">
