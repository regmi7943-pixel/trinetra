...
const reviews = [
  {
    ...
    date: "March 15, 2026",
    rating: 5,
    text: "Absolutely wonderful experience at Trinetra Eye Care. Bijay was incredibly thorough and patient with all my questions. The staff made me feel comfortable from start to finish. Highly recommended!",
    color: "#D4A574",
  },
  {
    name: "Rajesh Patel",
    ...
    rating: 5,
    text: "I had my computerized eye exam here and the results are phenomenal. The entire team was professional and caring. My vision with my new glasses is better than I ever imagined. Thank you, Trinetra!",
    color: "#E8B89D",
  },
  {
    name: "Priya Menon",
    ...
    rating: 5,
    text: "The best eye care clinic I have ever visited. The modern equipment and the warm atmosphere made the entire process stress-free. Bijay explained everything clearly and thoroughly.",
    color: "#C4956A",
  },
  {
    name: "Vikram Singh",
    ...
    rating: 5,
    text: "From the reception to the consultation room, everything is top-notch. I was nervous about my eye condition but the team put me completely at ease. Recovery was smooth and quick!",
    color: "#D4A574",
  },
  {
    name: "Meera Joshi",
...
export default function ReviewsClient({ content }: { content: Record<string, string> }) {
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <EditableText
              ...
              defaultText={content?.hero_badge || "Patient Testimonials"}
              as="span"
          ...
          <EditableText
            ...
            defaultText={content?.hero_subtitle || "Based on 200+ reviews from our wonderful patients who trust us with their vision care"}
            as="p"
        ...
        <div className="max-w-2xl mx-auto text-center cta-section">
          ...
          >
            ...
            <EditableText
              ...
              defaultText={content?.cta_title || "Share Your Experience"}
              as="h2"
            ...
            <EditableText
              ...
              defaultText={content?.cta_description || "Your feedback helps us improve and helps others find quality eye care. We'd love to hear about your visit!"}
              as="p"
