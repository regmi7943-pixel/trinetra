...
const blogPosts = [
  ...
  {
    title: "LASIK Surgery in 2026: What You Need to Know Before the Procedure",
    excerpt:
      "Considering LASIK? Our comprehensive guide covers everything from candidacy requirements to recovery expectations and long-term outcomes.",
    image:
  ...
  {
    title: "The Complete Guide to Cataract Surgery Recovery",
    excerpt:
      "What to expect after cataract surgery — from the first day to full recovery. Tips, timelines, and answers to the most common patient questions.",
    image:
    ...
    >
      ...
      <section className="pt-32 pb-12 px-4 text-center">
        <div className="max-w-3xl mx-auto blog-hero">
          ...
          >
            Expert articles on eye health, treatments, and lifestyle tips to
            help you take the best care of your eyes.
          </p>
        </div>
      ...
      <section className="px-4 pb-20">
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            >
              Subscribe to our newsletter for the latest eye health tips,
              clinic news, and exclusive offers.
            </p>
